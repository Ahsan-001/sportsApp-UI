...
const BG_CARD_LIVE_1 = Color(0x5016A0B4);
const BG_CARD_LIVE_2 = Color(0x50D90924);
const BG_CARD_LIVE_3 = Color(0x50F0A716);
...
const kPrimeColor = Color(0xFFdeb158);
const kLightColor = Color(0xFFffffff);

const kDarkColor = Color(0xFF404553);
const kDarkLightColor = Color(0x96404553);

const kPrimeLightColor = Color(0xff222c40);
const kPrimebrightColor = Color(0xff222a40);

const h1HeadingBlack =
    TextStyle(fontWeight: FontWeight.bold, color: kDarkColor, fontSize: 30.0);
